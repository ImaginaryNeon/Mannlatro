return {
    ...
    misc = {
        ...
        achievement_descriptions = {
            ...
            ach_mannpower_strange10 = "Trigger playing cards with Stat Clocks 350 times in a run",
            ach_mannpower_strange11 = "Trigger playing cards with Stat Clocks 500 times in a run",
